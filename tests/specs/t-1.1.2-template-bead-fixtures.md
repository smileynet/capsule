...
Create templates/demo-capsule/issues.jsonl with a bead hierarchy: 1 epic, 1 feature, 2 tasks with acceptance criteria. Each bead has id, title, description, type, priority, and dependencies. This fixture provides the structured work items that drive the pipeline through its phases.
